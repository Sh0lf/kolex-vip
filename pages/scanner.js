	...
	return (
		<>
			...
			<div className='text-gray-custom mt-2 flex flex-col justify-center px-2'>
				<div className='justify-center relative mt-10 mb-5 flex max-h-96 overflow-y-hidden rounded-md border border-gray-700 pb-2 transition-all duration-300 dark:border-gray-300'>
				...
				<div className='justify-center relative mb-5 flex max-h-96 overflow-visible rounded-md border border-gray-700 pb-2 transition-all duration-300 dark:border-gray-300'>
